...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion" id="accordionSidebar">
            ...
            <div class="px-3 pt-3 d-none d-sm-inline-block navbar-search">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-dark bg-primary topbar mb-4 static-top shadow">
                    ...
                    <button id="sidebarToggleTop" class="btn btn-link d-inline rounded-circle mr-3">
                        <i id="toggleIcon" class="fa fa-arrow-left" style="color:#ffffff"></i>
                    </button>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            searchInput.addEventListener("keyup", function() {
                ...
                const links = document.querySelectorAll("#accordionSidebar .nav-item");
                ...
                links.forEach(link => {
                    ...
                    if (text.includes(keyword)) {
                        ...
                        // auto expand jika dalam collapse
                        if (collapseParent) {
        ...
        document.getElementById("sidebarToggleTop").addEventListener("click", function() {
            ...
            }, 100); // delay kecil agar mengikuti toggle bawaan SB2
        });
